...
export const useAppStore = create<AppStore>((set, get) => ({
  ...
  setDirectoryHandle: async (handle) => {
    ...
    set({ directoryHandle: handle, fileTree: tree, selectedFolderHandle: null })
  },
  ...
  setDiagram: (diagram) => set({ diagram, undoStack: [], redoStack: [], selection: new Set() }),

  setDiagramDirty: (dirty) =>
    set((s) => s.diagram ? { diagram: { ...s.diagram, isDirty: dirty } } : {}),
